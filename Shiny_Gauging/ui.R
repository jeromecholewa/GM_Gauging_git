      ...
      fluidRow(column(3, checkboxInput("showOhms", "Resistances", TRUE)),
               ...
               column(5,
                      textInput("display_fact",
                                ...
                                value = "50" ))),
      h4("Enter x and y ranges for the desired graph display"),
      fluidRow(column(3, textInput("x_min", "Enter x_min", value = "-1" )),
               column(3, textInput("x_max", "Enter x_max", value = "55" )),
               column(3, textInput("y_min", "Enter y_min", value = "-5" )),
               column(3, textInput("y_max", "Enter y_max", value = "270" ))),
      plotOutput("GaugingPlot1"),
      ...
      fluidRow(column(3, checkboxInput("showOhmsSec", "Sub Resistances", TRUE)),
               ...
               column(5,
                      textInput("display_factSec",
                                ...
                                value = "45" ))),
      h4("Enter x and y ranges for the desired SECONDARY graph display"),
      fluidRow(column(3, textInput("x_minSec", "Enter x_min", value = "-1" )),
               column(3, textInput("x_maxSec", "Enter x_max", value = "55" )),
               column(3, textInput("y_minSec", "Enter y_min", value = "-5" )),
               column(3, textInput("y_maxSec", "Enter y_max", value = "270" ))),
      plotOutput("GaugingPlotSec"),
